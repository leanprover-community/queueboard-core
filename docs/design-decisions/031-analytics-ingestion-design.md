...
- 2026-03-25:
  ...
  - `A6` implemented: `SITE_ANALYTICS_REJECT_EMPTY_UA` settings flag (default off) to drop requests with no `User-Agent` header; wired into the collect view before the existing bot-filter check.
