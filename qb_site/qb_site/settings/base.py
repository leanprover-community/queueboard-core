...
SYNCER_CI_SHA_STORAGE_DUAL_WRITE = env_bool(os.getenv("SYNCER_CI_SHA_STORAGE_DUAL_WRITE"), False)
...
ANALYZER_CI_SHA_READ_PRIMARY = env_bool(os.getenv("ANALYZER_CI_SHA_READ_PRIMARY"), False)
ANALYZER_CI_SHA_READ_FALLBACK_PR = env_bool(os.getenv("ANALYZER_CI_SHA_READ_FALLBACK_PR"), True)
