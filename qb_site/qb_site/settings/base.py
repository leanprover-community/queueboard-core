...
SYNCER_CI_SHA_STORAGE_DUAL_WRITE = env_bool(os.getenv("SYNCER_CI_SHA_STORAGE_DUAL_WRITE"), True)
SYNCER_CI_PR_STORAGE_WRITE = env_bool(os.getenv("SYNCER_CI_PR_STORAGE_WRITE"), True)
...
ANALYZER_CI_SHA_READ_PRIMARY = env_bool(os.getenv("ANALYZER_CI_SHA_READ_PRIMARY"), True)
ANALYZER_CI_SHA_READ_FALLBACK_PR = env_bool(os.getenv("ANALYZER_CI_SHA_READ_FALLBACK_PR"), False)
