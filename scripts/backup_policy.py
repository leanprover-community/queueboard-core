...
BACKUP_TABLES: tuple[str, ...] = (
    ...
    "syncer_labeldef",
    "syncer_prlabel",
    "syncer_prreviewinlinecomment",
    "syncer_prreviewinlinecommentbackfill",
...
EXPORT_TABLE_QUERIES: dict[str, str] = {
    ...
    "syncer_prreviewinlinecomment": "SELECT * FROM syncer_prreviewinlinecomment ORDER BY id",
    "syncer_prreviewinlinecommentbackfill": "SELECT * FROM syncer_prreviewinlinecommentbackfill ORDER BY review_event_id",
