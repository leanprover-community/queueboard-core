...
def main() -> None:
    ...
    # copy JSON files from API into place
    shutil.copy2(path.join("api", "automatic_assignments.json"), GH_PAGES_DIR)
    shutil.copy2(path.join("api", "dependency_graph.json"), GH_PAGES_DIR)
