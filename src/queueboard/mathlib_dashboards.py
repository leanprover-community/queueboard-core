...
class Dashboard(StrEnum):
    ...
    # Non-draft PRs opened from a branch to the mathlib repository itself (i.e., not from a fork)
...
def short_description(kind: Dashboard) -> str:
    ...
    return {
        ...
        Dashboard.QueueStaleAssigned: "assigned PRs on the review queue needing triage after two weeks without review movement",
        Dashboard.QueueStaleUnassigned: "unassigned PRs on the review queue needing triage after three days without a status change",
        ...
        Dashboard.NotFromFork: "ready PRs opened from a branch of the mathlib main repo",
...
def long_description(kind: Dashboard) -> str:
    ...
    return {
        ...
        Dashboard.QueueStaleAssigned: "all assigned PRs on the review queue that are shown here for triage after two weeks without review movement",
        Dashboard.QueueStaleUnassigned: "all unassigned PRs on the review queue that are shown here for triage after three days without a status change",
        ...
        Dashboard.NotFromFork: "all non-draft PRs, not labelled WIP, opened from a branch of the mathlib main repo (and not a fork) --- these should be migrated",
...
def getIdTitle(kind: Dashboard) -> Tuple[str, str]:
    ...
    return {
        ...
        Dashboard.QueueStaleAssigned: ("queue-stale-assigned", "Needs triage: assigned PRs on the review queue"),
        Dashboard.QueueStaleUnassigned: ("queue-stale-unassigned", "Needs triage: unassigned PRs on the review queue"),
        ...
        Dashboard.NotFromFork: ("unmigrated", "PRs from a branch of the main mathlib repo"),
